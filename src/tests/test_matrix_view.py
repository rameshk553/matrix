...
class TestMatrixView(unittest.TestCase):
    ...
    def test_select_operation_returns_matrix_operation_addition_when_input_value_is_1(self):
    ...
    def test_create_matrix_calls_for_user_input_twice_when_matrix_addition_operation_selected(self):
        with mock.patch('builtins.input',
                        side_effect=["[[1,2],[3,4]]",
                                     "[[5,6],[7,8]]",
                                     "[[5,6],[7,8]]",
                                     "[[5,6],[7,8]]"]) as mock_input:
    ...
    def test_perform_operation_calls_controller_add_method_with_passed_in_arguments(self):
        matrix1 = [[1, 2], [3, 4]]
        matrix2 = [[5, 6], [7, 8]]
